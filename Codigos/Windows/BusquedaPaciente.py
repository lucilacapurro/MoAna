...
#############################################################################################################################
    ...
    def setupUi(self, BusquedaPacientes):
        ...
        self.groupBox_BusquedaPaciente.setGeometry(QtCore.QRect(20, 20, 1150, 660))
        font = QtGui.QFont()
        ...
        self.label_BuscarNombre.setGeometry(QtCore.QRect(200, 80, 71, 50))
        font = QtGui.QFont()
        ...
        self.lineEdit_BuscarNombre.setGeometry(QtCore.QRect(295, 80, 655, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarNombre.setFont(font)
        ...
        self.label_BuscarApellido.setGeometry(QtCore.QRect(200, 135, 71, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.lineEdit_BuscarApellido.setGeometry(QtCore.QRect(295, 135, 655, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarApellido.setFont(font)
        ...
        self.label_BuscarID.setGeometry(QtCore.QRect(200, 190, 71, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.lineEdit_BuscarID.setGeometry(QtCore.QRect(295, 190, 655, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarID.setFont(font)
        ...
        self.label_BuscarFecha.setGeometry(QtCore.QRect(200, 245, 71, 50))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.lineEdit_BuscarDia.setGeometry(QtCore.QRect(295, 245, 50, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarDia.setFont(font)
        ...
        self.label_Barra.setGeometry(QtCore.QRect(355, 240, 10, 50))
        font = QtGui.QFont()
        ...
        self.lineEdit_BuscarMes.setGeometry(QtCore.QRect(375, 245, 50, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarMes.setFont(font)
        ...
        self.label_Barra_2.setGeometry(QtCore.QRect(435, 240, 10, 50))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.lineEdit_BuscarAo.setGeometry(QtCore.QRect(455, 245, 70, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_BuscarAo.setFont(font)
        ...
        self.listWidget_ListadoPacientes.setGeometry(QtCore.QRect(200, 350, 750, 230))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.listWidget_ListadoPacientes.setFont(font)
        ...
        self.pushButton_BuscarPaciente.setGeometry(QtCore.QRect(800, 300, 150, 40))
        font = QtGui.QFont()
        ...
        self.pushButton_SeleccionarPaciente.setGeometry(QtCore.QRect(800, 600, 150, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.pushButton_VolverBusquedaPaciente.setGeometry(QtCore.QRect(1200, 630, 140, 50))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
...
if __name__ == "__main__":
    ...
    BusquedaPacientes.showMaximized()
    sys.exit(app.exec_())
