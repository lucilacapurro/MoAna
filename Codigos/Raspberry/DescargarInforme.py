...
#########################################################################################################################
    ...
    def setupUi(self, DescargarInforme):
        ...
        self.pushButton_Descargar_DescargarInforme.clicked.connect(self.descargar_archivos_a_pendrive)
...
#FUNCIONES
    ...
    def descargar_archivos_a_pendrive(self):
