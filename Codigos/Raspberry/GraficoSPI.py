...
SPIEstados.update_layout(hovermode="x unified") # "x unified"


# COLORES FRANJAS ESTADOS
...
# Guardo la imagen estática del gráfico dinámico
SPIEstados.write_image(f"{directorio_actual}/{'figSPIEstados.jpg'}")


# ------------------------------------------------------------------------------------------------------------

# GRAFICO INTERACTIVO EVOLUCION SPI - RANGOS
...
SPIFranjas.update_layout(hovermode="x unified") # "x unified"
...
# GRAFICO INTERACTIVO EVOLUCION SPI - PORCENTAJES ESTADOS

def PorcentajesEstado(valsSPIestado):
    # calcula el porcentaje del tiempo del estado en que se encuentra el valor del SPI en cada franja 
